				...
				{!items ? (
					...
					<div className="row pt-5 d-flex justify-content-center text-black">
						{/* <div className="col-lg-4 col-md-6 col-12 mb-4">
							...
							<button className="btn btn-sm btn-brown me-2">
								<FaArrowDown /> Harga Terendah
							</button>
							<button className="btn btn-sm btn-dark-brown me-2">
								<FaArrowUp /> Harga Tertinggi
							</button>
						</div> */}
						{/* <div className="col-lg-4 col-md-6 col-12 mb-4">
							...
							{isAuthenticated && (
								<>
									...
									<Link href="/products/add">
										<a className="btn btn-sm btn-brown">
